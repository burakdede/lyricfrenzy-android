...
//	private ListView mList;
    ...
    private class TextToSpeechAction implements Action,OnInitListener{
		...
		public void onInit(int status) {
	        ...
	        if (status == TextToSpeech.SUCCESS) {
	            ...
	            Log.e(LYRIC_FRENZY, "Could not initialize TextToSpeech.");
	        }
		}
    }
    ...
    protected Dialog onCreateDialog(int id) {
		loadingDialog = ProgressDialog.show(SearchActivity.this, "", "Getting search results",true);
    ...
    private void startVoiceRecognitionActivity() {
        ...
        intent.putExtra(RecognizerIntent.EXTRA_PROMPT, "Speak lyrics out loud and clear");
